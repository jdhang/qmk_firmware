...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYM] = LAYOUT_split_3x6_3(
      //-------------------------------------------------------------------        ---------------------------------------------------------------------------------
        KC_NO, KC_GRV,  KC_MINS, KC_PLUS, KC_AT,           KC_PERC,                        KC_AMPR, KC_ASTR, KC_LBRC, KC_RBRC, KC_MINS,  KC_NO,
      //-------------------------------------------------------------------        ---------------------------------------------------------------------------------
    ...
    [_NAV] = LAYOUT_split_3x6_3(
      ...
      //------------------------------------------------------------------------         ---------------------------------------------------------------------------------
        KC_NO, KC_NO,  KC_NO,   KC_NO,      KC_NO,     KC_NO,                                     G(KC_LALT), KC_PGDN,      KC_PGUP,   KC_NO,      KC_NO,  TO(_COLE),
      //------------------------------------------------------------------------         ---------------------------------------------------------------------------------
    ...
    [_NUM] = LAYOUT_split_3x6_3(
      ...
      //-------------------------------------------------------------------         ---------------------------------------------------------------------------------
        KC_NO, KC_NO,     KC_NO, KC_NO, KC_NO,   KC_COMM,                                     KC_NO,  KC_4,   KC_5,  KC_6,  KC_MINS,  KC_NO,
      //-------------------------------------------------------------------         ---------------------------------------------------------------------------------
